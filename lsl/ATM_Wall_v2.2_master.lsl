// ═══════════════════════════════════════════════════════════════
// InCynq ATM Wall v2.2 — MASTER COPY
//
...
key TEX_BODY         = "28875b3d-d858-cc48-d1af-3ff904799156";  // ATM Wall body — all faces
...
checkScriptVersion() {
    ...
    for (i = 0; i < count; i++) {
        ...
        if (name != myName && llSubStringIndex(name, "InCynq ATM Wall v") == 0) {
            string verStr = llGetSubString(name, 17, -1);
