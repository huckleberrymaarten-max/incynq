    ...
    content: () => (
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '0 32px' }}>
        ...
        <div style={{ marginTop: 28, display: 'flex', flexDirection: 'column', gap: 8 }}>
          {[
            '📢 SALE ENDS TONIGHT! 50% off everything!',
            '🎉 DJ NIGHT!! Come to the Neon Lounge tonight!!',
            '💸 NEW RELEASES! Mesh body update available NOW',
            '📣 EVENT! Event! EVENT!! Be there or be square',
          ].map((m, i) => (
