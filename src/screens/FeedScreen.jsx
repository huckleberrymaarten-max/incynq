            ...
            <div style={{ display: 'flex', gap: 8, marginTop: 8, position: 'relative' }}>
              <div style={{ flex: 1, position: 'relative' }}>
                <input value={commentText} onChange={e => setCommentText(e.target.value)}
                  ...
                  style={{ width: '100%', boxSizing: 'border-box', background: C.card2, border: `1px solid ${C.border}`, color: C.text, fontSize: 12, padding: '7px 12px', borderRadius: 20, outline: 'none', fontFamily: 'inherit' }} />
              </div>
