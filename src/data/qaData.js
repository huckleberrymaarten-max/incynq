    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { q: "Can I opt out of brand analytics tracking?", a: "It is applied at the interaction level, not the user level, because the brand dashboard depends on it working for all viewers. If you object, email legal@incynq.app and we'll discuss options under GDPR." },
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { q: "What are the ad tiers?", a: "⚡ Basic — starting at 150 L$/week. Highlighted in search and explore. ⭐ Featured — starting at 400 L$/week. Featured card injected in feed. 👑 Premium — starting at 800 L$/week. Top story, feed, and explore banner. Prices scale with the size of the InCynq community — everyone pays the same current tier rate." },
          ...
          { q: "Will ad prices increase?", a: "Yes. Pricing is tiered based on the size of the InCynq community — as we grow, everyone moves to the next tier together. We will always give you at least 30 days' notice before a tier change. Brands that join early benefit from the lower tiers until the community reaches the next threshold." },
      ...
      },
      {
        ...
        items: [
          ...
          { q: "What is the suspension process?", a: "First serious offence: immediate suspension, Brand Wallet frozen, all ads paused, Dashboard Upgrade paused. You can appeal at legal@incynq.app within 14 days. Second offence or extremely severe first offence: permanent ban, wallet forfeited, no appeal." },
