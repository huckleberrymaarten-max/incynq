    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { q: "Does the welcome credit expire?", a: "Yes — the 100 L$ welcome credit expires 90 days after your account activation if unused. Topped-up credits do not expire." },
        ],
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { q: "Will ad prices increase?", a: "Yes. Current pricing is launch pricing. As InCynq's audience grows, prices will increase. We will always give you at least 30 days' notice. Brands that join early lock in the best rates until prices change." },
      ...
      },
      {
        ...
        items: [
          ...
          { q: "Are wallet balances refundable?", a: "No. All wallet L$ is non-refundable. This applies to activation fees, ad spend, event boosts, and Cynqified application fees. Only top up what you plan to spend." },
      ...
      },
      {
        ...
        items: [
          { q: "What emails do brand accounts receive?", a: "Account emails (suspension notices, billing confirmations) always come through. Optional emails include: Ad Performance Reports (weekly reach summary) and Billing & Wallet (top-up reminders). Both are on by default and individually toggleable in Settings." },
